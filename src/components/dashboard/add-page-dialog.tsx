...
const TEMPLATES = [
  ...
  { title: "Exercícios", emoji: "🏃", color: "#7c2d12", special: "exercicios", desc: "Treinos do YouTube + agenda semanal" },
  { title: "Cursos", emoji: "🎓", color: "#0891b2", special: "cursos", desc: "Cadernos por categoria + cards de anotações" },
];
