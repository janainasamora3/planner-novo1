...
function sanitizePage(raw: unknown): PageCard | null {
  ...
  const special: PageCard["special"] | undefined =
    specialRaw === "social-media" || specialRaw === "enterprise" || specialRaw === "business-plan" || specialRaw === "books" || specialRaw === "tasks" || specialRaw === "caverna" || specialRaw === "planejamento" || specialRaw === "finance" || specialRaw === "ideas" || specialRaw === "quick-tasks" || specialRaw === "fitness" || specialRaw === "exercicios" || specialRaw === "cursos"
      ? specialRaw
      : undefined;
